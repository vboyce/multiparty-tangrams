      ...
      <Centered>
        <div className="instructions">
          ...
          <p>In this task, you will be assigned to a team with {treatment.playerCount -1} other {treatment.playerCount>2 ? "people ": "person "} 
            ...
            <p>You should expect this {treatment.playerCount}-player game will take roughly <strong>{treatment.playerCount==2 ? "40 minutes. " : treatment.playerCount==3? "50 minutes. ": "an hour. "}
            ...
            "You will recieve $7 base pay. "}  </strong> You will also be able to earn up to <strong> $2.88</strong> in additional bonuses depending on your performance in the game. </p>
