...
model <- brm(words ~ block * numPlayers + (block|tangram)+ (1|playerId)+(1|tangram_group)+(block|gameId), data=model_input,file="model1",                            prior=priors, control=list(adapt_delta=.95))
...
model_speaker_acc <- brm(words ~ block * numPlayers +block*was_INcorrect+ (block|tangram)+ (1|playerId)+(1|tangram_group)+(block|gameId), data=model_input,file="speaker_acc",                         prior=priors, control=list(adapt_delta=.95))
