...
```{r}
save_plot(here(image_location,"CAMP-legend.pdf"),plot_grid(get_legend(for_legend)), base_width=7, base_height=.5)
save_plot(here(image_location,"CAMP-acc.pdf"),accuracy, base_width=5, base_height=5)
save_plot(here(image_location,"CAMP-div.pdf"),diverge, base_width=5, base_height=5)
save_plot(here(image_location,"CAMP-con.pdf"),converge, base_width=5, base_height=5)
save_plot(here(image_location,"CAMP-red.pdf"),reduction, base_width=5, base_height=5)
