...
message("Most people think they understood directions")

exit |> group_by(name,correctness) |> tally() # most people think they understood directions

message("Did you think you were playing with humans? Mostly yes.")
...
message("people mostly thoughts they worked well together")
...
Not sure what the right way to visualize this is
