...
```{r}
# foo <- read_csv(here(data_location, "draft_filter_chat.csv")) |> 
#   mutate(is.chatchat=ifelse(chitchat=="x", T, F)) |> 
#   select(-chitchat) |> 
#   rename(spellchecked=spellcheck) |> write_csv(here(data_location, "filtered_chat.csv"))
```
