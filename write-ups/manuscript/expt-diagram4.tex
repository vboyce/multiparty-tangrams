...
\begin{tikzpicture}
	...
	%	\node[bound, ultra thick, anchor=north west, minimum width=28em, minimum height=28em] (block) at (7, 5) {};
		\node[anchor=north west] () at (\ax+11.2, \ay+1.3) {\includegraphics[width=14em]{images/fig_diagram.png}};
								\node[anchor=north ] () at (\ax+9.5, \ay+1.2) {Chat};
				\node[anchor=north west] () at (\ax+7.4, \ay+.8) {\includegraphics[width=10.5em]{images/chat_diagram.png}};
						\node[anchor=north west] () at (\ax+7.4, \ay-1.7) {\includegraphics[width=10.5em]{images/chat_diagram_2.png}};

		
		\node[illus, anchor=north west, minimum width=28em, minimum height=19em, ultra thick] (block) at (\ax+7, \ay+3) {};
		\node[illus, anchor=north west, minimum width=26em, minimum height=15em, ultra thick] (block) at (\ax+7.35, \ay+2.2) {};
...
\node[align=center, anchor=north] at (\colc, \clabx-.9) {Describer rotation};
	...
	\node[illus, anchor=north, minimum width=12em] () at (\colc,\claby) {Rotating describer\\ \includegraphics[height=4em]{images/rotate.png}};
	\node[illus, anchor=north, minimum width=12em] () at (\colc, \clabz) {Same describer\\ \includegraphics[height=4em]{images/norotate.png}};	
