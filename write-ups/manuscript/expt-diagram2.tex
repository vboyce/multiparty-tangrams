...
\begin{tikzpicture}
		...
		\node at (-3,4) {\LARGE\bfseries{A}};
		\node at (6,4) {\LARGE\bfseries{B}};
	 ...
	 \node[illus, anchor=east] () at (15,-2.5) {Emoji \\ \includegraphics[height=2.5em]{images/nochat.png}};
	 \node[align=center, anchor=center] at (15.5,-1.5) {Listener  Backchannel};
	\node[illus, anchor=west] () at (15.2,-2.5) {Chat \\ \includegraphics[height=2.5em]{images/chat.png}};

		%\node[illus,anchor=east] () at (15,-4.5) {Two person \\ \includegraphics[height=2em]{images/two.png}};
		%	 \node[align=center, anchor=center] at (15,-3.7) {Group  size};
	%\node[illus, anchor=west] () at (15.2,-4.5) {Six person \\ \includegraphics[height=2em]{images/six.png}};
	
	\node[illus, anchor=east] () at (15.4,2.5) {Rotate speaker\\ \includegraphics[height=3em]{images/rotate.png}};
		 \node[align=center, anchor=center] at (15.5,3.5) {Group  coherence:  Speaker rotation};
	\node[illus, anchor=west] () at (15.6,2.5) {Consistent speaker\\ \includegraphics[height=3em]{images/norotate.png}};
	
	\node[illus, anchor=east] () at (15.4,0) {Limited feedback\\ \includegraphics[height=4em]{images/limited-wrong.png} 
\phantom{m} \includegraphics[height=4em]{images/limited-correct.png}};
	\node[align=center, anchor=center] at (15.5,1.1) {Group  coherence:  Feedback};
	\node[illus, anchor=west] () at (15.6,0) {Full feedback \\  \includegraphics[height=4em]{images/full-wrong.png}  \phantom{m} \includegraphics[height=4em]{images/full-correct.png}	};

		
		\node[illus, anchor=north west] () at (6, 2.3) {\includegraphics[width=15em]{images/diagram.png}};
		\node[anchor=north west] () at (8, 2.7) {Trial};
		
		\node[illus, anchor=north west, minimum width=18.5em, minimum height=14.5em] (block) at (5.5, 3) {};
		\node[anchor=north west] () at (8, 3.5) {Block};
		\node[anchor=north west] () at (10, -1.5) {x 12 images};
		\node[anchor=north west] () at (10, -2.1) {x 6 iterations};
