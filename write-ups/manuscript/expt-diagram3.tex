...
\begin{tikzpicture}
	...
	%	\node at (13,4) {\LARGE\bfseries{C}};
		...
		\node (n2) at (0,0) [expt1, fill=expt1col, label={[expt1col]below:2}] {};
		\node (n3) at (\t/4,0) [expt1, fill=expt1col, label={[expt1col]below:3}] {};
		\node (n4) at (\t/2,0) [expt1, fill=expt1col, label={[expt1col]below:4}] {};
		\node (n5) at (3*\t/4,0) [expt1, fill=expt1col, label={[expt1col]below:5}] {};
		\node (n6) at (\t,0) [expt1, fill=expt1col] {};
		\node[align=center,anchor=north,text=expt1col] at (\t*1.1,-.45) {6 baseline};
		
		\node (n2thick) at (0,\t) [expt3, fill=expt3col, label= {[expt3col]above right:2 thick}] {};
		\node (n6thick) at (\t,\t) [expt3, fill=expt3col, label={[expt3col]right:6 thick}] {};
		
		\node (nfull) at (\t+.2,\t/2-.2) [expt2, fill=expt2col, label={[expt2col, align=center] right :6 full \\feedback}] {};
		\node (nsingle) at (\t-.2,\t/2+.2) [expt2, fill=expt2col, label={[expt2col, align=center ]above right :6 consistent\\ speaker}] {};
		
		\node (n2thin) at (-\t/1.4, -\t/1.4) [expt3, fill=expt3col, label={[expt3col]below right: 2 thin}] {};
		\node (n6thin2) at (\t-\t/1.4+.1, -\t/1.4+.1)[expt2, fill=expt2col, label={[expt2col] right: 6 thin}] {};
		\node (n6thin) at (\t-\t/1.4-.1, -\t/1.4-.1) [expt3, fill=expt3col, label={[expt3col]below right: 6 thin}] {};
	...
	%	\node[bound, ultra thick, anchor=north west, minimum width=28em, minimum height=28em] (block) at (7, 5) {};
		\node[illus, anchor=north west] () at (8.3, 2.3) {\includegraphics[width=20em]{images/diagram.png}};
...
%	\node[bound, ultra thick, anchor=north, minimum width=50em, minimum height=17em] (block) at (6.5, -5.5) {};
	 ...
	 \node[illus, anchor=east] () at (1.8,-10.3) {Emoji \\ \includegraphics[height=3.5em]{images/nochat.png}};
	 \node[align=center, anchor=center] at (2.5,-9) {Listener  Backchannel};
	\node[illus, anchor=west] () at (2,-10.3) {Chat \\ \includegraphics[height=3.5em]{images/chat.png}};

		\node[illus,anchor=east] () at (11.4,-10.3) {Two person \\ \includegraphics[height=3em]{images/two.png}};
			 \node[align=center, anchor=center] at (11.5,-9) {Group  size};
	\node[illus, anchor=west] () at (11.6,-10.3) {Six person \\ \includegraphics[height=3em]{images/six.png}};
	
	\node[illus, anchor=east] () at (2.4,-6.8) {Rotate speaker\\ \includegraphics[height=4em]{images/rotate.png}};
		 \node[align=center, anchor=center] at (2.5,-5.5) {Group  coherence:  Speaker rotation};
	\node[illus, anchor=west] () at (2.6,-6.8) {Consistent speaker\\ \includegraphics[height=4em]{images/norotate.png}};
	
	\node[illus, anchor=east] () at (11.4,-7) {Limited feedback\\ \includegraphics[height=5em]{images/limited-wrong.png} 
\phantom{m} \includegraphics[height=5em]{images/limited-correct.png}};
	...
	\node[illus, anchor=west] () at (11.6,-7) {Full feedback \\  \includegraphics[height=5em]{images/full-wrong.png}  \phantom{m} \includegraphics[height=5em]{images/full-correct.png}	};
