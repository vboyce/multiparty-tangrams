...
\begin{tikzpicture}
	...
	%	\node at (13,4) {\LARGE\bfseries{C}};
		...
		\draw (\bx,\by) edge[-Stealth, line width=1] [axis, "Matcher Backchannel", sloped, pos=.55] (\bx-\r/1.4,  \by-\r/1.4) ;
...
%	\node[bound, ultra thick, anchor=north, minimum width=50em, minimum height=17em] (block) at (6.5, -5.5) {};
	...
	\node[toplabel, align=center, anchor=north] at (\colb,\clabx) {Matcher Backchannel};
