...
As their audience grows, speakers face new challenges that do not arise in one-on-one conversation. 
They must consider multiple perspectives and weigh multiple sources of feedback to build shared understanding.
Here, we explore several key properties of the group's *interaction structure* that may facilitate successful communication under these conditions.
First, we introduce a novel extension of the dyadic repeated reference game paradigm for groups ranging from two to six participants. 
Across 313 games (1319 participants), we manipulated several constraints on the group's interaction structure, including the thickness of the feedback channel and the availability of lateral interaction within the audience of listeners.
While larger groups suffered disproportionately under these constraints, we found that larger groups were able to converge on efficient shared conventions as effectively as smaller groups under favorable interaction structure. 
Overall, these results shed new light on the core structural factors that enable group communication to thrive.
