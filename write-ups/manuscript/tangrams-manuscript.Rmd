...
```{r triptych-acc, fig.env = "figure*", fig.pos = "t!", fig.width=10, fig.height=5, fig.align = "center", set.cap.width=T, num.cols.cap=2, fig.cap = "Listner accuracy at selecting the target image. ", cache=FALSE}
# accuracy
