...
In a model of similarities between utterances produced at the same point in the game for the same tangram across different games (`r form(div_spec_3)`), TODO everything is tiny and also very significant, probably print more sigfigs!
