...
At school, teachers address large classrooms of children. 
At home, we chat with groups of friends and family members over dinner.
At the office, we attend meetings with groups of colleagues and managers.
...
For example, speakers need to account for the fact that different listeners in the group may have different mental states and levels of background understanding [@horton2005; @horton2002;@yoon2018; @yoon2014; @weber2003;@fox-tree2013], while listeners must account for the fact that utterances are not directly tailored to them [@fay2000; @carletta1998; @metzing2003; @yoon2019; @rogers2013; @cohngordon; @schober1989;@tolins2016]. 
...
What aspects of communication channels and interaction structure determine how efficiently a group can communicate?
...
We focused on dimensions that could affect how groups interacted with each other and sampled points along four dimensions that parameterize the interaction space. 
Our experiments systematically manipulated group size, speaker rotation, level of feedback, and the form of the listener backchannel; other possible dimensions, such as what the target images were or if participants had prior relationships, were held constant across games. 
Across the three experiments, we sampled 11 different points in the experimental space, illustrated in Figure \@ref(fig:diagram)A. 
