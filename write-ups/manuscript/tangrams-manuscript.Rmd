...
The length of matcher interjections also decreased over time for all games (Supplement Figure 3B, `r stats(list_1,2)`), consistent with the need for early matcher involvement in establishing referential conventions. 
