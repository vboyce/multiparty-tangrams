...
Think about structuring these sorts of narrative results around key descriptive claims, e.g., the topic sentences of paragraphs.
e.g., “Accuracy reduced modestly in larger groups.”
e.g., “Listeners also produced less language over the duration of games, consistent with the idea that backchannels were used primarily earlier in games before conventions emerged.

“Behaviorally, larger games are similar to smaller … ” - this is a key summary sentence, maybe it can be provided before results rather than after? (though again behaviorally maybe not the right modifier)

Section 2 - “in addition to …” - start by telling us WHY! what’s the goal of this analysis?


Results for 1.2 need much more interpretation up front to guide us to what you want us to see… the pink sentences in the GD are the key ones and need to be hammered in results AND the GD.

I know you feel the limitations and it’s good to point them out. but you only need 1-2 paragraphs max. It’s also very good to use them to point to future work! how can your innovative method help answer some of these limitations in future?
-->
