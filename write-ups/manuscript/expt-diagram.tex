...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\node[illus, anchor=north] () at (-4,-3.5) {	\includegraphics[scale=.15]{images/nochat.png}};
		\node[illus, anchor=north] () at (-4,-1) {\includegraphics[scale=.15]{images/chat.png}};
			
		\node[illus, anchor=north] () at (-4,4) {\includegraphics[scale=.09]{images/rotate.png}};
		\node[illus, anchor=north] () at (-1,8) {\includegraphics[scale=.09]{images/norotate.png}};
		
		
		%\node[illus, anchor=north] () at (-2,-.4) {\includegraphics[scale=.07]{images/two.png}};
		\node[ anchor=north] () at (7,1) {\includegraphics[scale=.07]{images/six.png}};
		
		\node[illus, anchor=north] () at (-5,2) {	\includegraphics[scale=.1]{images/limited-wrong.png}	\includegraphics[scale=.1]{images/limited-correct.png}};
		\node[illus, anchor=north] () at (-4.5,6.5) {	\includegraphics[scale=.1]{images/full-wrong.png}	\includegraphics[scale=.1]{images/full-correct.png}};
