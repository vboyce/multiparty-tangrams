...
\textbf{Larger groups suffered disproportionately under interaction constraints, but in less-constrained interaction structures (``thick channels''), they were able to converge on efficient shared conventions as effectively as smaller groups.}
...
In experiment 3, larger groups had worse initial accuracy (\(\beta=-0.64,\:95\%\:\mathrm{CrI}=[-1.05, -0.25]\))
...
Thicker games converged faster than thin games (Figure \ref{fig:sbert}B-C, \(\beta=-0.025,\:95\%\:\mathrm{CrI}=[-0.033, -0.017]\)).
