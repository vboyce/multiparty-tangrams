...
While communication is generally expected to deteriorate as groups get larger Seaman \& Basili (\protect\hyperlink{ref-seaman1997communication}{1997}), several factors have been identified in previous qualitative work that may slow such deterioration, each of which relates to the ``thickness'' of feedback Parisi \& Brungart (\protect\hyperlink{ref-parisi2005evaluating}{2005}).
...
Thin games were similar to thick games in initial verbosity (Figure \ref{fig:behavioral}F, \(\beta=0.8,\:95\%\:\mathrm{CrI}=[-2.85, 4.26]\)) and reduction rate ( \(\beta=0.29,\:95\%\:\mathrm{CrI}=[-0.56, 1.23]\)).

The main effect of being one block later was -3.36, (\(95\%\mathrm{CrI}=[-4.56, -2.18]\)) words per trial in experiment 1; -5.31, (\(95\%\mathrm{CrI}=[-6.35, -4.3]\)) words for 6 consistent speaker; -4.64, (\(95\%\mathrm{CrI}=[-5.81, -3.53]\)) words for 6 full feedback, -2.1, (\(95\%\mathrm{CrI}=[-3.37, -1.12]\)) words for 6 thin; and -2.24, (\(95\%\mathrm{CrI}=[-2.92, -1.57]\)) for the 2 thick condition of experiment 3.
