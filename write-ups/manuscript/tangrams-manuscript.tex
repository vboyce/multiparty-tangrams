...
In Experiment 3, larger games began with lower initial accuracy (\(\beta=-0.36,\:95\%\:\mathrm{CrI}=[-0.78, 0.05]\)) and improved more slowly (\(\beta=-0.36,\:95\%\:\mathrm{CrI}=[-0.78, 0.05]\)) than smaller games, although group size differences were not reliable in Experiment 1 (SI Table 4).
...
Overall, we found that larger groups displayed a higher proportion of trials where at least one matcher produced utterances (Supplement Figure 3A, \(\beta=0.79,\:95\%\:\mathrm{CrI}=[0.58, 0.98]\)), which declined across repetition blocks (\(\beta=-2.67,\:95\%\:\mathrm{CrI}=[-3.54, -1.79]\)).
The length of matcher interjections also decreased over time for all games (Supplement Figure 3B, \(\beta=4.72,\:95\%\:\mathrm{CrI}=[0.09, 9.44]\)), consistent with the need for early matcher involvement in establishing referential conventions.
