...
The length of matcher interjections also decreased over time for all games (Supplement Figure 3B, \(\beta=-0.17,\:95\%\:\mathrm{CrI}=[-1.53, 1.3]\)), consistent with the need for early matcher involvement in establishing referential conventions.
