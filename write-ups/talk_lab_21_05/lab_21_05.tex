...
\begin{frame}{\large Results: Tangrams vary in nameability}
	\includegraphics[width=\textwidth]{../images/words_tangrams.pdf}
		\begin{tikzpicture}[remember picture,overlay]
	\node[xshift=3.4cm,yshift=.4cm] at (current page.west) 
	{\includegraphics[width=.1\textwidth, trim={2cm 2cm 2cm 2cm}, clip]{../images/tangram_E.png}};
	\node[xshift=2.3cm,yshift=2.9cm] at (current page.south) 
	{\includegraphics[width=.1\textwidth, trim={2cm 2cm 2cm 2cm}, clip]{../images/tangram_K.png}};
	\node[xshift=-.3cm,yshift=-2.1cm] at (current page.north) 
	{\includegraphics[width=.1\textwidth, trim={2cm 2cm 2cm 2cm}, clip]{../images/tangram_B.png}};
...
\begin{frame}{\large Future analyses: Semantics}
		\begin{tikzpicture}[remember picture,overlay]
	\node[xshift=-2.3cm,yshift=-3.2cm] at (current page.north east) 
